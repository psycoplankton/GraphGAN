...
Original file is located at
    https://colab.research.google.com/drive/18eH6cviwGPDd-6sadGRCEc14_a7hKbsf
"""
...
training_path = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_train.txt"
testing_path = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_test.txt"
testing_negative_links_path = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_test_neg.txt"
embeddings = "/home/student/Vansh/GraphGAN/Pre-Train Embeddings/deepwalk_embeddings.emb"
...
lr_dis = 1e-4  # learning rate for the discriminator
n_epochs = 15 # number of outer loops
...
train_filename = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_train.txt"
test_filename = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_test.txt"
test_neg_filename = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_test_neg.txt"
train_test_filename = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_train_test.txt"
train_test_neg_filename = "/home/student/Vansh/GraphGAN/CA-GrQc Dataset/CA-GrQc_train_test_neg.txt"
train_result_filename = "/home/student/Vansh/GraphGAN/Results/train_results_deepwalk.txt"
pretrain_emb_filename_d = "/home/student/Vansh/GraphGAN/Pre-Train Embeddings/LINE_embeddings.emb"
pretrain_emb_filename_g = "/home/student/Vansh/GraphGAN/Pre-Train Embeddings/LINE_embeddings.emb"
emb_filenames = ["/home/student/Vansh/GraphGAN/Embeddings/gen.emb",
                 "/home/student/Vansh/GraphGAN/Embeddings/dis.emb"]
result_filename = "/home/student/Vansh/GraphGAN/Results/LINE_results.txt"
cache_filename = "/home/student/Vansh/GraphGAN/cache.pkl"
model_log = "/home/student/Vansh/GraphGAN/log/FF"
    ...
    def __init__(self, n_node, node_emd_init):
        ...
        with tf.GradientTape() as tape:
          self.loss = tf.reduce_sum(
              tf.nn.sigmoid_cross_entropy_with_logits(labels=self.label, logits=self.score)) + lambda_dis * (
                  tf.nn.l2_loss(self.node_neighbor_embedding) +
                  tf.nn.l2_loss(self.node_embedding) +
                  tf.nn.l2_loss(self.bias))
          optimizer = tf.compat.v1.train.AdamOptimizer(lr_dis)
...
class Generator(object):
    def __init__(self, n_node, node_emd_init):
        ...
        with tf.GradientTape() as tape:
          self.loss = -tf.reduce_mean(tf.math.log(self.prob) * self.reward) + lambda_gen * (
                  tf.nn.l2_loss(self.node_neighbor_embedding) + tf.nn.l2_loss(self.node_embedding))
        optimizer = tf.compat.v1.train.AdamOptimizer(lr_gen)
...
class GraphGAN(object):
    ...
    def train(self):
        ...
        for epoch in range(n_epochs):
            ...
            neighbor_nodes = []
            labels = []
            for d_epoch in range(n_epochs_dis):
                ...
                for start in start_list:
                    ...
                    self.sess.run(fetches = self.discriminator.d_updates,
            ...
            self.write_embeddings_to_file()
            self.evaluation(self, p=1) #training data results
            self.evaluation(self, p=0) #test data results
        ...
        if(p==0):
            ...
            if app == "link_prediction":
                for i in range(2):
                    ...
                    results.append(modes[i] + ":" + str(result) + "\n")
            ...
            if app == "link_prediction":
                for i in range(2):
                    lpe = LinkPredictEval(
                        emb_filenames[i], train_test_filename, train_test_neg_filename, self.n_node, n_embed)
                    result = lpe.eval_link_prediction()
                    results.append(modes[i] + ":" + str(result) + "\n")

            with open(train_result_filename, mode="a+") as f:
                f.writelines(results)
    print("7")
